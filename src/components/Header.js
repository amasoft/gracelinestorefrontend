...
const Header = () => {
    ...
    useEffect(() => {
      window.location.pathname === '/' ? setIsOpen(true) : setIsOpen(false);
    }, [])
                          ...
                          <div className="row">
                              <div className="col-lg-3">
                                  <div className="all-category">
                                      <h3 className="cat-heading"><i className="fa fa-bars" style={{cursor: "pointer"}} onClick={handleOpen} aria-hidden="true"></i></h3>
                                      {isOpen && (<ul className="main-category">
